...
function ChiefSlider(selector, config) {
  ...
  this._config = {
    loop: true,
    autoplay: false,  //остановить автопроигрывание
    interval: 6000,   //скорость перелистывания
    refresh: true,
    swipe: true,
  };
...
// _updateIndicators !!!убирает класс Актив индикторам. Полностью выключает переключение слайдов!!!
...
// _moveTo !!!выключает переключение слайдера нажатием на слайдер_индикаторс!!!
